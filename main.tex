...
\university{\href{http://www.university.com}{Universidad Nacional Aut\'onoma de
M\'exico}} % Your university's name and URL, this is used in the title page and abstract, print it elsewhere with \univname
\department{\href{http://department.university.com}{Divisi\'on de Ingenier\'ia
...
\group{\href{http://researchgroup.university.com}{Seminario de Ingenier\'ia}} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
\faculty{\href{http://faculty.university.com}{Facultad de Ingenier\'ia}} % Your faculty's name and URL, this is used in the title page and abstract, print it elsewhere with \facname
