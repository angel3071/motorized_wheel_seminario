...
Existe una real necesidad en el mercado mexicano de una silla de ruedas que
proporcione a los usuarios una ventaja sobre las actuales opciones, en el
presente trabajo se plantea una soluci\'on de ingenier\'ia para esta necesidad.
Se describe dicha soluci\'on en la cual, mediante los recursos que proporciona
la ingenier\'ia mecatr\'onica, se amplian las caracter\'isticas de una silla de
ruedas tradicional a las de una \emph{smart wheelchair}. Siguiendo las premisas
de un proyecto sustentable y fundamentado en la tecnolog\'ia actualmente
disponible.
\end{abstract}
